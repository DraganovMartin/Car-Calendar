...
public class ViewVehicleFragment extends Fragment {
    ...
    private void updateUI(Vehicle vehicle){
        ...
        if(car != null){
            ...
            // TODO : in Car class add two fields one representing when to change in km's which is current edit text and statically add Calendar field with +1 year of when the object is created see Vignette class
